      ...
      <div className={styles.contactGrid}>
        <aside className={styles.contactCard}>
          ...
          <div className={styles.contactItemRow}>
            <div className={`${styles.iconBox} ${styles.iconPhone}`}>📞</div>
            <div>
          ...
          <div className={styles.contactItemRow}>
            <div className={`${styles.iconBox} ${styles.iconPlace}`}>📍</div>
            <div>
          ...
          <div className={styles.quickContact}>
            <a className={styles.whatsapp} href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer"><img src="/whatsapp.png" alt="WhatsApp" className={styles.qcImg} /> WhatsApp</a>
            <a className={styles.callNow} href="tel:+919876543210"><img src="/phone.png" alt="Call" className={styles.qcImg} /> Call Now</a>
          </div>
        ...
        <form className={`${styles.bookingCard} ${submitting ? styles.disabledForm : ''}`} onSubmit={handleSubmit} noValidate>
          ...
          <button type="submit" aria-busy={submitting} className={styles.bookBtn} disabled={submitting}>
            <span className={styles.btnIcon} aria-hidden="true">
              <img src="/send.png" alt="" aria-hidden="true" background="white" />
            </span>
