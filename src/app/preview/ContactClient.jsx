      ...
      <div className={styles.contactGrid}>
        <aside className={styles.contactCard}>
          ...
          <div className={styles.quickContact}>
            <a className={styles.whatsapp} href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer">WhatsApp</a>
            <a className={styles.callNow} href="tel:+919876543210">Call Now</a>
          </div>
