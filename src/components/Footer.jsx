            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white">+91 9026 811603</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white">
                    deveshkumarphotography1@gmail.com
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-[#7c8390]">Shop No 22 , Krishi Export plaza Rathyatra Road Sigra varanasi</p>
                </div>
              </div>
            </div>
          </div>
